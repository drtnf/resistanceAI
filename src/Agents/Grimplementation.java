...
public class Grimplementation extends Agent{

  //Accept no failure! Traitors and all who support them must die!
  //Keep a reputation score for all players, have it cascade through voting and missions.
  //Likewise, betray always. Assume that the resistance are fools.
