...
public class MontyCarlo extends Agent{

  //Tries each move and randomly simulates as many games as possible
  //Picks move which most likely lead to success (paramaterised)
  //
  //With a partial game tree, apply minimax with alpha-beta pruning on tree.
  //
